  ...
  return (
    <>
      ...
      <div
        ...
        className={`absolute top-full right-0 mt-2 w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700 transform ${isDropdownOpen ? 'translate-x-0' : 'translate-x-full'} ${isDropdownOpen ? 'opacity-100' : 'opacity-0'} transition-transform ease-in-out duration-300 ${isDropdownOpen ? 'pointer-events-auto' : 'pointer-events-none'}`}

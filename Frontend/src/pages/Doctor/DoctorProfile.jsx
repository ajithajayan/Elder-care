          ...
          <div className="grid grid-cols-6 gap-6">
            <div className="col-span-6 sm:col-span-3">
              ...
              <input
                ...
                placeholder="Bonnie"
                required=""
                // value={doct.data.first_name|| ''}
                defaultValue={about.first_name?about.first_name:''}
              />
            </div>
            <div className="col-span-6 sm:col-span-3">
              <label
              ...
              <input
                ...
                placeholder="Green"
                required=""
                defaultValue={about.last_name?about.last_name:''}
              />
            </div>
            <div className="col-span-6 sm:col-span-3">
              <label
            ...
            <div className="col-span-6 sm:col-span-3">
              ...
              <input
                ...
                required=""
                defaultValue={about.phone_number?about.phone_number:''}
              />
            </div>
            <div className="col-span-6 sm:col-span-3">
              <label
              ...
              <input
                ...
                required=""
                defaultValue={about.date_of_birth?about.date_of_birth:''}
              />
            </div>
            <div className="col-span-6 sm:col-span-3">
              <label
